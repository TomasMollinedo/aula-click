...
| `class-variance-authority`      | Variantes (`variant`, `size`) de los primitivos de `components/ui/` (T-13/T-25: shadcn/ui hecho a mano, sin el CLI).                                                                        |
