...
Contiene solo código **sin significado de negocio**: paginación, primitivas de Zod, normalización y términos de búsqueda, fechas, el tipo `Actor` y la forma de salida de la auditoría.
