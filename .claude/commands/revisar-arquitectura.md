...
18. **Route groups y layout:** dos route groups que resuelven a la misma ruta; un route group de rol nuevo mientras la decisión D-06 siga abierta; un `layout.tsx` de route group que valida sesión o rol; Header o Sidebar montados en `src/app/layout.tsx` o fuera de `AppShell`.
